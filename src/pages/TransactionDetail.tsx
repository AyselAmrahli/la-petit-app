  ...
  const transactionDetail = detail?.map((item, index) => {
    return (
      <Fragment key={index}>
        ...
        <ListItem className={classes.listItem}>
          Merchant:
          <ListItemText className={classes.listText} primary={`${item.merchantInfo.name} / ${item.merchantInfo.category}`} />
        </ListItem>
        
        <ListItem className={classes.listItem}>
          Transaction Date:
          <ListItemText className={classes.listText} primary={item.transactionDate} />
        </ListItem>
      </Fragment>
    )
  });
